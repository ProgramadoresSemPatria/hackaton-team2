        ...
        <>
            <Modal isOpen={true}>
                <section className="text-white font-inter flex flex-col gap-2 ">
                    ...
                    <div className="my-1">
                        <a href="#" className="underline">www.google.com/careers/123</a>
                    ...
                    <footer className="flex flex-col-reverse items-center sm:grid grid-cols-2 gap-2 mt-1 sm:mt-5">
                        <a href="#" className="text-center hover:text-primary-color transition-colors duration-150 ease-linear">Fechar</a>
